...
def parse_args():
    parser = argparse.ArgumentParser(description="Fine-tune torchvision ResNet34.")
    parser.add_argument("--data", default="CNN_dataset4")
    parser.add_argument("--output", default="runs/resnet34_5")
...
def main():
    ...
    best_epoch = 0
    history = []
    checkpoint_path = output_dir / "best_resnet34.pt"
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_loss < best_val_loss:
            ...
            best_weights = copy.deepcopy(model.state_dict())
            torch.save(
                {"architecture": "resnet34", "model_state": best_weights, "class_to_idx": class_to_idx,
    ...
    metrics = {"architecture": "resnet34", "best_epoch": best_epoch, "best_val_loss": best_val_loss,
