...
from .obb_predict import predict_obb_frame
...
class ShrimpSexRatioAnalyzer:
    ...
    def __init__(self, monitoring=None, obb_model_path=None, hbb_model_path=None) -> None:
        ...
        self._hbb_model_path = hbb_model_path or MODEL_HBB_PATH
    ...
    def _predict_obb_frame(self, frame):
        return predict_obb_frame(self.obb_model, frame)

    def _track_obb_frame(self, frame, tracker_config: str | None):
        raise ValueError("predict analyzer does not support track mode. Use general_track or multi_channel_track.")
